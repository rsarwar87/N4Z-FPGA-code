...
cell xilinx.com:ip:cordic:6.0 cordic_ssb {
    ...
    s_axis_cartesian_tdata [get_concat_pin [list [get_slice_pin fir_i/m_axis_data_tdata  30 15] [get_slice_pin fir_q/m_axis_data_tdata  30 15] ] concat_audio_iq]
...
cell koheron:user:latched_mux:1.0 data_for_fifo {
            ...
            clken [get_constant_pin 1 1]
            din [get_concat_pin [list c_addsub_0/S cordic_ssb/m_axis_dout_tdata  cic_i/m_axis_data_tdata fir_i_inputs/dout ] data_options ]
...
cell koheron:user:latched_mux:1.0 dac0_mux {
            ...
            clk ps_0/fclk_clk0 
            sel [get_slice_pin ctl/user_io 16 16]
            clken [get_constant_pin 1 1]
